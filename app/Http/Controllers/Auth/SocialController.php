    ...
    */
    public function socialLogin($social)
    {
        if ($social == 'github') {
            ...
            return redirect('https://api.intra.42.fr/oauth/authorize?client_id=ad621af753cdab32eb73006372af41da6240ca0f38204be154ecc2a9485782bc&redirect_uri=http%3A%2F%2Fhypertube.techhub.com%2Fsocialauth%2Fintra%2Fcallback&response_type=code');
        }
    }
        ...
        switch ($social) {
            ...
            case "intra":
                ...
                $credital = [
                    ...
                    "code" => $_GET['code'],
                    "redirect_uri" => env('INTRA_REDIRECT'),
                ];
